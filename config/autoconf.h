...
#define CONFIG_LIB_RT_FORCE 1
#undef  CONFIG_LIB_USB0112_FORCE
#undef  CONFIG_LIB_USB100_FORCE
#undef  CONFIG_LIB_ALSA_FORCE
#undef  CONFIG_LIB_AO_FORCE
#undef  CONFIG_LIB_GUPNPAV_FORCE
...
#undef  CONFIG_RALINKAPP_SWITCH
#undef  CONFIG_RALINKAPP_LONG_LOOP
...
#undef  CONFIG_RALINKAPP_SCRIPTS
...
#define CONFIG_ASUS_NVRAM 1
#define CONFIG_ASUS_INFOSVR 1
#define CONFIG_ASUS_NETWORKMAP 1
#define CONFIG_ASUS_HTTPD 1
#define CONFIG_ASUS_WWW 1
#define CONFIG_ASUS_APCLI_WPS 1
#undef  CONFIG_ASUS_I2C_CTRL
#undef  CONFIG_DPROXY
#undef  CONFIG_PPPOE_RELAY
#undef  CONFIG_TC
#define CONFIG_UDHCPD 1
#undef  CONFIG_BPALOGIN
#undef  CONFIG_PPPD
#undef  CONFIG_EZ_IPUPDATE
#define CONFIG_IGMPPROXY 1
#undef  CONFIG_L2TP
 ...
 * Audio Application
 */
#undef  CONFIG_ASUS_AUDIO
#undef  CONFIG_ASUS_PLAYER
#undef  CONFIG_USER_ALSA_UTILS
#undef  CONFIG_USER_MPG123
#undef  CONFIG_USER_M3PLAYER
#undef  CONFIG_USER_SHAIRPORT
#define CONFIG_VENDOR "ASUS"
#define CONFIG_PRODUCT "RP-N12"
#define CONFIG_SSID "ASUS_RPN12"
