...
function validForm(){
	...
	if(document.form.http_passwd_x.value == ""){
			showError("<#QIS_pass_alert_desc1#>");
	...
	if(document.form.http_passwd_x.value != document.form.http_passwd_2_x.value){
			showError("<#QIS_pass_alert_desc2#>");
			document.form.http_passwd_x.value = "";
			document.form.http_passwd_x.focus();
			document.form.http_passwd_x.select();
			return false;                   
	...
	if(document.form.http_passwd_x.value == 'admin'){
			showError("<#QIS_pass_alert_desc7#>");
			document.form.http_passwd_x.value = "";
			document.form.http_passwd_x.focus();
			document.form.http_passwd_x.select();
			return false;
...
var validator = {
	chkLoginId: function(obj){
		...
		if(obj.value == ""){
			showError("<#QIS_pass_alert_desc4#>");
			obj.value = "";
			obj.focus();
			obj.select();
			return false;
			...
			if(obj.value == "root" || obj.value == "guest" || obj.value == "anonymous"){
				showError("<#QIS_pass_alert_desc8#>");
				obj.value = "";
				obj.focus();
				obj.select();
				return false;
			...
			showError("<#QIS_pass_alert_desc5#>");
			obj.value = "";
			obj.focus();
			obj.select();
			return false;
			...
			<div>
				<table class="content">
					<tr style="height:43px;">
						...
						<td align="left">
							<div class="title_name"><#System_title_no_ntp#></div>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<div class="p1" style="margin:35px 0px 0px 78px;">
								<div style="margin-bottom:10px;">
									<#model_name#> is currently not protected and uses an unsafe default username and password.
								</div>
								<div style="margin-bottom:10px;">
									<#QIS_pass_desc1#>
								</div>
					...
					<tr id="router_name_tr" style="display:none">
						<td colspan="2">
							<div style="color:#FFF;margin:20px 0px -10px 78px;"><#QIS_pass_LoginName#></div>
						</td>
					</tr>				
					<tr style="height:72px;">
						<td colspan="2">
							<div style="margin:20px 0px 0px 78px;">
								<input type="text" name="http_username_x" tabindex="1" class="form_input" maxlength="20" value="" autocapitalize="off" autocomplete="off" placeholder="<#QIS_pass_LoginName#>">
							</div>
						</td>
					</tr>
					<tr id="router_password_tr" style="display:none">
						<td colspan="2">
							<div style="color:#FFF;margin:20px 0px -20px 78px;"><#System_PASS_new#></div>
						</td>
					</tr>					
					<tr style="height:72px;">
						<td colspan="2">
							<div style="margin:30px 0px 0px 78px;">
								<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_x" tabindex="2" class="form_input" maxlength="16" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#System_PASS_new#>">
							</div>
						</td>
					</tr>
					<tr id="router_password_confirm_tr" style="display:none">
						<td colspan="2">
							<div style="color:#FFF;margin:20px 0px -20px 78px;"><#System_PASS_retype#></div>
						</td>
					</tr>							
					<tr style="height:72px;">
						<td colspan="2">
							<div style="margin:30px 0px 0px 78px;">
								<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_2_x" tabindex="3" class="form_input" maxlength="16" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#System_PASS_retype#>">
							</div>
						</td>
					</tr>
					<tr style="heigh:72px">
