...
function add_list()
{
	...
	$("loadingBlock").style.marginLeft = "400px";	
	$("loadingBlock").style.position = "absolute";
	winW_H();
	var blockmarginTop;
	blockmarginTop = document.documentElement.scrollTop + 200;	
	$("dr_audio_advise").style.marginTop = blockmarginTop+"px"
	$("add_RadioList").style.width = winW+"px";
	$("add_RadioList").style.height = winH+"px";	
	$("add_RadioList").style.visibility = "visible";
}
...
function add_url()
{
	...
	blockmarginTop = document.documentElement.scrollTop + 200;	
	$("dr_audio_advise").style.marginTop = blockmarginTop+"px"
	$("add_RadioStation").style.width = winW+"px";
	$("add_RadioStation").style.height = winH+"px";	
	$("add_RadioStation").style.visibility = "visible";
}   
