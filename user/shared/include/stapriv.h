...
typedef enum _RT_802_11_PHY_MODE {
	...
	PHY_11ABG_MIXED = 3,
	PHY_11G = 4,
	PHY_11ABGN_MIXED = 5,		/* 5  -> both band */
	PHY_11N_2G = 6,			/* 6  -> 11n-only with 2.4G band */
	PHY_11GN_MIXED = 7,		/* 7  -> 2.4G band */
	PHY_11AN_MIXED = 8,		/* 8  -> 5G  band */
	PHY_11BGN_MIXED = 9,		/* 9  -> if check 802.11b. */
	PHY_11AGN_MIXED = 10,		/* 10 -> if check 802.11b. */
	PHY_11N_5G = 11,		/* 11 -> 11n-only with 5G band */
#ifdef IEEE802_11AC
