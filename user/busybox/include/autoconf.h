 ...
 */
#define AUTOCONF_TIMESTAMP "2019-07-10 12:42:50 EEST"
...
#define USE_FEATURE_HAVE_RPC(...)
#define SKIP_FEATURE_HAVE_RPC(...) __VA_ARGS__
...
#undef CONFIG_PARSE
#define ENABLE_PARSE 0
#define USE_PARSE(...)
#define SKIP_PARSE(...) __VA_ARGS__
...
#define USE_FEATURE_FAST_TOP(...)
#define SKIP_FEATURE_FAST_TOP(...) __VA_ARGS__
...
#define ENABLE_FEATURE_DEPMOD_PRUNE_FANCY 0
#define USE_FEATURE_DEPMOD_PRUNE_FANCY(...)
#define SKIP_FEATURE_DEPMOD_PRUNE_FANCY(...) __VA_ARGS__
#undef CONFIG_FEATURE_DEPMOD_ALIAS
#define ENABLE_FEATURE_DEPMOD_ALIAS 0
#define USE_FEATURE_DEPMOD_ALIAS(...)
#define SKIP_FEATURE_DEPMOD_ALIAS(...) __VA_ARGS__
...
#define USE_FEATURE_TOP_CPU_GLOBAL_PERCENTS(...)
#define SKIP_FEATURE_TOP_CPU_GLOBAL_PERCENTS(...) __VA_ARGS__
...
#define USE_ASH_BASH_COMPAT(...)
#define SKIP_ASH_BASH_COMPAT(...) __VA_ARGS__
...
#define USE_ASH_BUILTIN_PRINTF(...)
#define SKIP_ASH_BUILTIN_PRINTF(...) __VA_ARGS__
