 ...
 *
 * $Id: mtd.c,v 1.2 2010-08-03 08:37:58 winfred Exp $
 *
...
#ifdef UPGRADE_PROGRESS_SUPPORT
...
mtd_write(int imagefd, int offset, int len, const char *mtd)
{
	...
	unsigned char *test_buf;
#ifdef UPGRADE_PROGRESS_SUPPORT
	#define UPGRADE_PROGRESS_LEVEL 5
	char nv[3];
	int upgrade_resolution = len / UPGRADE_PROGRESS_LEVEL;
#endif
...
#ifdef UPGRADE_PROGRESS_SUPPORT
		sprintf(nv, "%d", (UPGRADE_PROGRESS_LEVEL - len / upgrade_resolution));
		nvram_set("led_drv_upgrading", nv);
#endif
