...
function initial(){
	...
	showLANIPList();
	showvts_rulelist();
	//addOnlineHelp($("faq"), ["ASUSWRT", "port", "forwarding"]);//Barton tmp mark
			...
			<table width="760px" border="0" cellpadding="4" cellspacing="0" class="FormTitle" id="FormTitle">
			  ...
			  <tr>
				<td bgcolor="#4D595D" valign="top">
				  <div>&nbsp;</div>
				  <div class="formfonttitle"><#menu7#> - <#menu7_3#></div>
				  ...
				  <div class="formfontdesc" style="margin-top:-10px;">
					<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#menu7_3#>&nbspFAQ</a>
				  </div>
				  ...
				  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
					...
					<tr>
					  <th><#IPConnection_VServerEnable_itemname#></th>
					  <td>
				  ...
				  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table">
					...
					<tr>
					  <th><#IPConnection_VSList_itemname1#></th>
					...
					<tr>
					  <td width="27%"><input type="text" maxlength="30" class="input_20_table" name="vts_desc_x_0" onKeyPress="return is_string(this, event)"/></td>
					  <td width="15%"><input type="text" maxlength="" class="input_12_table" name="vts_port_x_0" onkeypress="return is_portrange(this, event)"/></td>
					  <td width="21%">
					  ...
					  <td width="10%"><input type="text" maxlength="5"  class="input_6_table" name="vts_lport_x_0" onKeyPress="return is_number(this,event);"/></td>
					  <td width="13%">
					  ...
					  <td width="14%"><input type="button" class="add_btn" onClick="addRow_Group(32);" name="vts_rulelist2" value=""></td>
					</tr>
				  </table>
