	...
	if ('<% nvram_get("ddns_enable_x"); %>' == 1) {
		...
		if ('<% nvram_get("ddns_server_x"); %>' == "WWW.ASUS.COM" || '<% nvram_get("ddns_server_x"); %>' == "") {
			...
			if (hostname_x != '' && ddns_hostname_title)
				...
				document.getElementById("DDNSName").value = "<#LANHostConfig_x_DDNS_hint#>";
		} else {
			...
			if (hostname_x != '')
				...
				document.getElementById("ddns_hostname_x").value = "<#LANHostConfig_x_DDNS_hint#>";
		}
...
function validate_ddns_hostname(o){
	...
	if (s == "") {
		show_alert_block("<#JS_Usernameblank#>");
		return false;
	}
...
function cleandef(){
	if (document.form.DDNSName.value == "<#LANHostConfig_x_DDNS_hint#>")
			...
			<table width="760px" border="0" cellpadding="5" cellspacing="0" class="FormTitle" id="FormTitle">
			  ...
			  <tr>
				<td bgcolor="#4D595D" valign="top">
				  <div>&nbsp;</div>
				  <div class="formfonttitle"><#menu7#> - <#menu7_5#></div>
				  ...
				  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
					...
					<tr>
					  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,14);"><#LANHostConfig_x_DDNSUserName_itemname#></a></th>
					...
					<tr>
					  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,15);"><#LANHostConfig_x_DDNSPassword_itemname#></a></th>
					...
					<tr id="wildcard_field">
					  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,16);"><#LANHostConfig_x_DDNSWildcard_itemname#></a></th>
					  <td>
					...
					<tr style="display:none;">
					  <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,17);"><#LANHostConfig_x_DDNSStatus_itemname#></a></th>
					  <td>
						<input type="hidden" maxlength="15" class="button_gen" size="12" name="" value="<% nvram_get("DDNSStatus"); %>">
						<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#CTL_refresh#>" />
					  </td>
					</tr>
				  </table>
