...
function initial(){
	...
	showautofw_rulelist();
	//addOnlineHelp($("faq"), ["ASUSWRT", "port", "trigger"]);//Barton tmp mark
}

function load_WellKnownApplications(){
	wItem = new Array(new Array("Quicktime 4 Client", "554", "TCP", "6970:32000", "UDP"), 
...
function addRow_Group(upper){
	if (validForm()) {
		...
		//match(out port+out_proto+in port+in_proto) is not accepted
		if (item_num >= 2) {
			for (i=0; i<rule_num; i++) {
			...
			<table width="760px" border="0" cellpadding="4" cellspacing="0" class="FormTitle" id="FormTitle">
			  ...
			  <tr>
				<td bgcolor="#4D595D" valign="top">
				  <div>&nbsp;</div>
				  <div class="formfonttitle"><#menu7#> - <#menu7_2#></div>
				  <div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
				  <div class="formfontdesc"><#IPConnection_porttrigger_sectiondesc#></div>
				  <div class="formfontdesc" style="margin-top:-10px;">
					<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#menu7_2#>&nbspFAQ</a>
				  </div>

				  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
					<thead>
					<tr>
					  <td colspan="6"><#LANHostConfig_BasicConfig#></td>
					</tr>
					</thead>
				  ...
				  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0"  class="FormTable_table">
					...
					<tr>
					  <td width="22%"><input type="text" maxlength="18" class="input_15_table" name="autofw_desc_x_0" onKeyPress="return is_string(this, event)"></td>
					  <td width="21%"><input type="text" maxlength="11" class="input_12_table"  name="autofw_outport_x_0" onKeyPress="return is_portrange(this,event)"></td>
					  <td width="10%">
					  ...
					  <td width="21%"><input type="text" maxlength="11" class="input_12_table" name="autofw_inport_x_0" onKeyPress="return is_portrange(this,event)"></td>
					  <td width="10%">
					  ...
					  <td width="16%"><input type="button" class="add_btn" onClick="addRow_Group(32);" name="" value=""></td>
					</tr>
				  </table>
